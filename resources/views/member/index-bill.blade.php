...
@section('title','Đơn hàng của khách')
@section('content')
@parent
        ...
        <div class="row">
          <div class="col-12">
            <div class="card card-info">
              ...
              <div class="card-body">
              <form action=""  id="formBillindex" url="{!!url('member/don-hang')!!}">
                  <div class="form-group row">
                    ...
                    <div class="col-sm-2"> 
                      ...
                      <a href="{{route('member.bill')}}"><button type="button"  class="btn btn-info">Back</button></a>
                    </div>
                    </form>  
                  </div>
                <br/>
