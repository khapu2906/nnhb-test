                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-5">
                                                ...
                                                <input type="text" class="form-control" name="accountname" id="memName" placeholder="Enter name" value="{{$admin->accountname}}">
                                            </div>
                                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-7 ">
                                                <label for="memEmail">Email</label>
                                                <input type="text" class="form-control" name="email" id="memEmail" placeholder="Enter Email" value="{{$admin->email}}">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group">
