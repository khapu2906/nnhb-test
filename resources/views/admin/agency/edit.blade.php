                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-5">
                                                ...
                                                <input type="text" class="form-control" name="name" id="cusName" placeholder="Enter name" value="{{$agency->name}}">
                                            </div>
                                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-3">
                                                <label for="cusPhone">Phone</label>
                                                <input type="number"  maxlength="11" minlength="9" class="form-control" name="phone" id="cusPhone" placeholder="Enter phone" value="{{$agency->phone}}">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="cusEmail">Email</label>
                                        <input type="text" class="form-control" name="email" id="cusEmail" placeholder="Enter Email" value="{{$agency->email}}">
                                    </div>
                                    <div class="row">
